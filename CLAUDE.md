...
All prose written in this repo (blog posts, docs, commit messages, code comments) should read
like a person wrote it, not a language model. Specific rules:

- Never use em dashes. Use a period, comma, or colon instead.
- Avoid AI clichés: "delve," "underscore," "pivotal," "robust," "seamless," "leverage," "holistic."
- Avoid rhetorical contrast crutches: "It's not just X, it's Y," "This isn't about X, it's about Y,"
  "No X. No Y. Just Z."
- Avoid the "**Bold term:** explanation" list format as a default structure. It's the most
  recognizable AI tic.
- Don't open with throat-clearing like "It's important to note that..." or "In today's fast-paced
  world...".
- Don't reflexively write in groups of three. Vary sentence length and structure.
- Be specific and concrete rather than generically impressive-sounding.
